...
DATAPATH = '/home/rxue/GRL/heterophilic_data'
...
class Hetero:
    def __init__(self, dataset_name, device):
        ...
        data = np.load(os.path.join(DATAPATH, f'{dataset_name.replace("-", "_")}.npz'))
        ...
        self.data.train_mask = self.train_masks
        self.data.val_mask = self.val_masks
        self.data.test_mask = self.test_masks
